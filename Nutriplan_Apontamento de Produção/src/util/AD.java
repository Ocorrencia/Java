...
public class AD {
    ...
    public static LdapContext getConnection(String username, String password, String domainName, String serverName) throws NamingException {
        ...
        try {
            ...
            throw new NamingException("Falha ao conectar ao " + domainName + ((serverName == null) ? "" : " through " + serverName));
        } catch (NamingException e) {
            throw new NamingException("Fallha ao autenticar o usuário " + username + "@" + domainName + ((serverName == null) ? "" : " through " + serverName));
        }
    }
